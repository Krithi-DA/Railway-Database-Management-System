...
<table class="table">
    ...
    <tbody>
        <?php
        $fetch_query = "SELECT * FROM complaint";
        ...
        if (mysqli_num_rows($fetch_query_run) > 0) {
                ...
                <tr>
                    ...
                    <td>
                        <form action="cv.php" method="GET">
                            <input type="hidden" name="Complaint_Number" value="<?php echo $row['Complaint_Number'] ?>">
        ...
        else
         {
            ?>
            <tr>
            <td colspan="16" style="text-align: center; vertical-align: middle; font-weight:bold; 
            color: darkred;">No data found</td>                
            </tr>
            <?php
        }
        ?>
