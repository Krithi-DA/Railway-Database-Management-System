...
<head>
    ...
    <title>Cancelled Ticket Details</title>
    <style>
        body
         {
...
<table class="table">
    <thead>
        <tr>
            ...
            <th scope="col">Passenger Middlename</th>
    ...
    <tbody>
        <?php
        $fetch_query = "SELECT * FROM cancelled_ticket_log";
            ...
            foreach ($fetch_query_run as $row) {
                ...
                <td><?php echo $row['Passenger_fname'] ?></td>
                    ...
                    <td><?php echo $row['Cancelled_Time'] ?></td>
                        <form action="canceltv.php" method="GET">
